...
const title = "Buffet Setup"
const description = `A Buffet Setup service for your business.
            ...
            <div className="container mx-auto px-2 lg:px-10 mt-5 mb-20 lg:mb-5">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
                    ...
                    <div>
                        ...
                        <Link href="/buffet-menus" className="btn btn-outline btn-primary normal-case rounded-full mt-8">Select Your Favourite Menus</Link>
                    </div>
                </div>
            </div>
            <PackageReviews />

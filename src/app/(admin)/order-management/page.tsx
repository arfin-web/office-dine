    ...
    return (
        <>
            <div className="container mx-auto px-2 lg:px-10 mt-5 mb-20 lg:mb-5">
                <h1 className="text-2xl font-bold mb-5">Manage Your<span className="text-primary"> Orders</span></h1>
                    ...
                    <table className="table">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th className="text-primary text-base">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                orders.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <select className="select select-primary w-28">
